        ...
        <div className="flex justify-between items-center py-4 px-5 bg-white shadow">
            ...
            <div className="flex gap-4">
                ...
                {newLink && (
                    <Link
                        href={newLink}
                        className="py-1 px-2 bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800 flex items-center space-x-2 text-white font-semibold"
                    >
