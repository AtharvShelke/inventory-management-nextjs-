...
export default async function InvoiceDetail({ params }) {
    ...
    let invoice, session, role;
    try {
        // Fetch invoice and session data concurrently
        [invoice, session] = await Promise.all([
            getRequest(endpoint),
        ...
        return <div>Something went wrong while fetching the invoice.</div>;
    }
    ...
    const renderInvoiceItems = () => {
        return invoice.invoiceItems.map((item, rowIndex) => {
